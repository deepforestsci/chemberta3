...
def infograph_finetune_classification(dataset: str, epochs: int, pretrained_checkpoint_path: str, output_filename: str, n_tasks: int, n_classes: int):
...
if __name__ == "__main__":
    ...
    infograph_finetune_classification(dataset=args.dataset, 
                        epochs=args.epochs, 
